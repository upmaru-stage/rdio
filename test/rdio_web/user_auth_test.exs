defmodule RdioWeb.UserAuthTest do
  use RdioWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Rdio.Accounts
  alias RdioWeb.UserAuth
  import Rdio.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RdioWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      RdioWeb.Endpoint.subscribe(live_socket_id)
